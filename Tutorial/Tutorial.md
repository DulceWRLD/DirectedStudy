...
You should now see another menu that has an option called "Building Parts"
...
Once you're done adding all your devices, it should look something like this:
...
Fill out the menu with the name you want
...
Right-click on the middle group you want to add your group address to
...
Next, navigate to the upper area of the screen to the device that has the same name as the middle group the group address is under
...
Navigate to the menu and click on it, navigate to the diagnostics section
...
Now click on the data point type and navigate to 5.001 percentage
...
Now, you should see this in the group monitor to tell that it's working:
...
Now, enter the individual address 1.1.7
...
Once the detector turns on, you should see it flashing indicating you have successfully restarted it
